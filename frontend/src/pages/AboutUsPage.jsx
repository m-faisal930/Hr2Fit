  ...
  return (
    < >
        ...
        <div className={`mx-auto px-4 sm:px-6 lg:px-8 relative z-10 ${colors.bgSecondary}`}>
          ...
          >
            ...
            <h2 className={`text-5xl md:text-6xl font-bold ${colors.textPrimary} mb-8 font-palo`}>
              Our Outsourced{' '}
              <span className={`bg-gradient-to-r from-[${colors.primary}] via-[${colors.secondary}] to-[${colors.tertiary}] bg-clip-text text-transparent animate-gradient`}>HR Service</span> Approach
            </h2>
            ...
            <div className={`w-48 h-2 bg-gradient-to-r from-[${colors.primary}] via-[${colors.secondary}] to-[${colors.tertiary}] mx-auto rounded-full`}></div>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div variants={fadeInUp} custom={1}>
              <h3 className={`text-4xl font-bold ${colors.textPrimary} mb-8 font-palo`}>
                Customized HR to{' '}
                <span className={`bg-gradient-to-r from-[${colors.primary}] to-[${colors.secondary}] bg-clip-text text-transparent`}>Fit Your Business</span>
              </h3>
              <div className={`space-y-6 ${colors.textSecondary} leading-relaxed font-vastago text-lg`}>
                ...
                <p>
                  ...
                  <span className={`font-semibold bg-gradient-to-r from-[${colors.primary}] to-[${colors.secondary}] bg-clip-text text-transparent`}>
                    Fortune 500 quality
                  </span>
                  .
                </p>
              ...
              >
                <div className={`flex items-center gap-3 ${colors.textSecondary}`}>
                  <FaCheckCircle className={`${colors.iconSuccess} text-xl`} />
              ...
              <div className={`relative p-10 bg-gradient-to-br from-[${colors.primary}]/20 to-[${colors.secondary}]/20 backdrop-blur-2xl rounded-3xl border-2 border-[${colors.primary}]/30 shadow-2xl`}>
                ...
                <div className="relative z-10">
                  <div className="grid grid-cols-2 gap-8">
                    <motion.div
                      className={`text-center p-6 rounded-3xl bg-[${colors.primary}]/15 backdrop-blur-xl border-2 border-[${colors.primary}]/30 shadow-lg`}
                      whileHover={{ scale: 1.05, y: -8 }}
                      transition={{ type: 'spring', stiffness: 300 }}
                    >
                      <FaUsers className={`text-5xl ${colors.iconPrimary} mx-auto mb-4`} />
                    ...
                    <motion.div
                      ...
                      transition={{ type: 'spring', stiffness: 300 }}
                    >
                      <FaShieldAlt className={`text-5xl ${colors.iconPrimary} mx-auto mb-4`} />
                    ...
                    <motion.div
                      ...
                      transition={{ type: 'spring', stiffness: 300 }}
                    >
                      <FaRocket className={`text-5xl ${colors.iconPrimary} mx-auto mb-4`} />
                    ...
                    <motion.div
                      ...
                      transition={{ type: 'spring', stiffness: 300 }}
                    >
                      <FaDollarSign className={`text-5xl ${colors.iconPrimary} mx-auto mb-4`} />
      ...
      >
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className={`text-5xl md:text-6xl font-bold ${colors.textPrimary} mb-8 font-palo`}>
              Why Choose <span className={`bg-gradient-to-r from-[${colors.primary}] via-[${colors.secondary}] to-[${colors.tertiary}] bg-clip-text text-transparent animate-gradient`}>HR 4 Your business</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              },
              {
                ...
                color: 'from-secondary-600 to-tertiary-600'
              },
              {
                icon: FaGlobe,
                title: 'Comprehensive',
                description: 'Complete HR solutions under one roof',
                color: 'from-tertiary-600 to-primary-600'
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
                ...
                transition={{ type: 'spring', stiffness: 300 }}
              >
                <div className={`relative p-10 bg-gradient-to-br from-[${colors.primary}]/20 to-[${colors.secondary}]/20 backdrop-blur-2xl rounded-3xl border-2 border-[${colors.primary}]/30 overflow-hidden shadow-2xl`}>
                  ...
                  <div className="relative z-10">
                    <div className={`w-20 h-20 bg-gradient-to-br from-[${colors.primary}] to-[${colors.secondary}] rounded-3xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
      ...
      <motion.section
        ...
        viewport={{ once: true }}
      >
        <div className="absolute inset-0 bg-gradient-to-br from-primary-500/15 to-secondary-500/15"></div>
