...
<section className="relative flex flex-col-reverse md:flex-row mx-auto justify-between items-center gap-9 md:gap-4 max-w-[1300px] py-4 my-12">
  ...
  <div className="relative z-20 w-full max-w-[430px]">
    ...
    <div className="absolute -top-4 -left-4 w-16 h-16 border-2 border-[#8176AF] rounded-full opacity-30"></div> */}
      ...
      {/* Contact Info Bar */}
      <div className={`flex relative z-30 justify-center sm:justify-between gap-5 items-center mt-6 mx-auto max-w-[1300px] rounded-[90px] py-3 px-3 sm:p-8 lg:p-14 ${colors.bgSecondary}`}>
